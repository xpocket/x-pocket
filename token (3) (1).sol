...
contract XPOCKET is ERC20Detailed, ERC20Pausable {
    uint8 public constant DECIMALS = 18;
    uint256 public constant INITIAL_SUPPLY = 50000000 * (10 ** uint256(DECIMALS));

    constructor () public ERC20Detailed("XPocket", "POCKET", DECIMALS) {
        _mint(0xd52ACd6CbeF4F103B46Babf8cD63bfF432168C21, 5000000 ether); //Uniswap address
        _mint(0xce3ee1BC32b4952dA26F119b68923793A5D5Ad30, 5000000 ether); //team address
        _mint(0x6DC901FA8712d46414931066C10efC254514EE23, 12500000 ether); //marketing address
        _mint(0xE2F2b815e912cb029674EC84c3CD09538485e630, 27500000 ether); //token sale address
    }
